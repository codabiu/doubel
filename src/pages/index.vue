<template>
    <div>
        ...
        <div class="index-list">
          ...
          <div class="a">
            <h2 class="el-icon-tickets">最新博客</h2>
          ...
          <div class="b">
            <h2 class="el-icon-collection-tag">最近待办</h2>
          ...
          <div class="c">
            <h2 class="el-icon-chat-square">最新留言</h2>
        ...
        <div class="index-other">
           <div class="index-other__me">
             ...
             <span class="index-other__me-name">自己</span>
             <span class="index-other__me-msg">前端菜鸟</span>
             <el-divider content-position="center"><i class="el-icon-phone-outline"></i>联系方式</el-divider>
             <el-popover
    ...
    return {
      ...
      info: [
        ...
        },
        {
          ...
          title: 'email',
          msg: '1262244864@qq.com'
        }
      ],
      blog: {title: 'Vue.js面试题', time: '2022-07-20 14:30', msg: 'beforeCreate在实例初始化前被触发。created会在实例初始化之后、被添加到DOM之前触发。', look: 1212, up: 100, tags: ['Vue.js', 'js']},
